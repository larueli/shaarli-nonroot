...
RUN wget https://github.com/shaarli/Shaarli/releases/download/${SHAARLI_VERSION}/shaarli-${SHAARLI_VERSION}-full.zip && unzip shaarli-${SHAARLI_VERSION}-full.zip  && rm shaarli-${SHAARLI_VERSION}-full.zip  && \
